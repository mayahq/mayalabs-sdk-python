        ...
        for event in events:
            if event['topic'] == 'nodeexecstatus':
                if (event['data']['status'] == 'running'):
                    ...
                    print(maya_log_prefix, Fore.CYAN + f'Running node: {nodeId}' + Style.RESET_ALL)
            
            if event['topic'] == 'debug':
                ...
                print(maya_log_prefix, LOG_COLOR + f'Received {logLevel} message from node {nodeId}: {content}' + Style.RESET_ALL)
